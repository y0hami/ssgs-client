...
declare const GSClient: typeof Client;
declare const GSEndpoint: typeof Endpoint;
export { GSClient, GSEndpoint, Color, ColorRange, ColorRanges, GradientColor, FlashEffectFrequency, Game, GameEvent, GameEventHandler, DeviceType, EventIcon, GameColor, HeadsetZone, IndicatorZone, KeyboardZone, MouseZone, RgbPerKeyZone, RgbZone, VisualizationMode, };
